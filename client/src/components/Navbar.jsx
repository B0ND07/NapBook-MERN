        ...
        <nav className='h-24 flex items-center justify-between'>
            ...
            {user?<div className="text-center flex gap-4 items-center">
                              <div>
                                        ...
                                        <div>
                                        <button onClick={logoutHandler} className="  text-gray-50 bg-red-500 hover:text-white-50 hover:bg-red-600 border-solid border py-2 px-2 rounded-lg w-18 text-center transition duration-200 box-border">Log out</button></div>
                                    </div>:
